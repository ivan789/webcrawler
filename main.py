...
''' 
    Ova skripta radi parsanje html-a koristeci modul BeautifulSoup, dakle ovu skriptu
    poziva django view kada korisnik pokrene web crawler-a, korisnik preda kroz web formu
    log fajl s imenima kanala koje zeli pretraziti, te pokrene crawler i ova skripta se aktivira!
'''
